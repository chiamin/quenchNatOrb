...
MYFLAGS=-I$(MYDIR) -I$(MYDIR)/latt -I$(MYDIR2) -fmax-errors=3 -Wno-unused-variable -Wno-unused-function -Wno-sign-compare

HEADERS=MyObserver.h tdvp.h TDVPObserver.h Corr.h GenMPO.h FourierTransf.h RotateBasis.h Unitary.h test.h
